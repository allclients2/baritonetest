...
import baritone.utils.schematic.format.defaults.SpongeSchematicNew;
...
public enum DefaultSchematicFormats implements ISchematicFormat {
    ...
    SPONGE("schem") {
        ...
        public IStaticSchematic parse(InputStream input) throws IOException {
            ...
            int version = nbt.getCompound("Schematic").getInt("Version");
            switch (version) {
                case 2:
                    return new SpongeSchematic(nbt);
                case 3:
                    return new SpongeSchematicNew(nbt);
                default:
                    throw new UnsupportedOperationException("Unsupported Version of a Sponge Schematic, Version: " + version);
            }
        }
    },
