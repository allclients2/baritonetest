...
/**
 * VarInt (variable-length integer) is an adjustable integer size which can be 8,16,32,64,etc. bytes long. But also with extra bytes which tell its size. (TO MY UNDERSTANDING OF IT) -allclients2, 12th of May 2024.
 * @author Brady
 * @since 12/19/2019
 */
